...
<div class="navbar-fixed">
    <nav>
        <div class="nav-wrapper">
            <a href="{{ route('pages.root') }}" class="brand-logo center-align center"><i class="fa fa-rocket"></i> Legacy18 Admin</a>
            <ul class="left">
                <li>
            ...
            <ul class="side-nav" id="slide-out">
                ...
                <li>    
                    <a href="{{route('admin::event_report')}}"><i class="fa fa-2x fa-home"></i> EventReport</a>
                </li>
